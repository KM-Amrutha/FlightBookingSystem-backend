export enum ProviderStatus {
    ListRetrieved = "Providers list retrieved successfully",
  FailedToRetrievePrivdersList = "Failed to retrieve trainers list",
  Approved = "Provider has been successfully addeded.",
